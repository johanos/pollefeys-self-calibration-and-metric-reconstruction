...
data_root_path = 'TestingData/SceneNetRGBD'
protobuf_path = 'TestingData/SceneNetRGBD/scenenet_rgbd_val.pb'
output_path = 'TestingData/optical_flow/SceneNetRGBD/'
...
if __name__ == '__main__':
    ...
    traj = trajectories.trajectories[0]
    ...
    for idx,view in enumerate(traj.views):
        ...
        optical_flow_path = f'optical_flow_{view.frame_num}.png'
        ...
        optical_flow_derivatives = optical_flow(points_in_world,view.shutter_close, traj.views[idx + 1].shutter_open)
        ...
        finalPath = os.path.join(output_path , traj.render_path )
        if not os.path.exists(finalPath):
            os.makedirs(finalPath)

        finalPath =  os.path.join(finalPath,  optical_flow_path)
        print(finalPath)
        imageio.imsave(finalPath,rgb)